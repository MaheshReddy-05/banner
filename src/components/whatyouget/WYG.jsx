          ...
          <div className=" ">
            <div className="grid grid-cols-2 ">
              <div className="col-span-1 my-auto">
                ...
                A strong understanding of data structures allows candidates to solve complex problems and demonstrate 
                their ability to write efficient code. We have detailed step by step detailed videos to 
                build DSA concepts (Link to SDE revision sheet) 
                </div>
              </div>
              <div className="col-span-1 my-auto ">
                <LLD></LLD>
